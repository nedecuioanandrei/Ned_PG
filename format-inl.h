...
inline void fwrite_fully(const void* ptr,
                         size_t size,
                         size_t count,
                         FILE* stream) {
...
struct gen_digits_handler {
  ...
  FMT_CONSTEXPR digits::result on_digit(char digit,
                                        uint64_t divisor,
                                        uint64_t remainder,
                                        uint64_t error,
                                        bool integral) {
...
FMT_CONSTEXPR20 inline void format_dragon(fp value,
...
template <typename Float>
FMT_HEADER_ONLY_CONSTEXPR20 int format_float(Float value,
                                             int precision,
                                             float_specs specs,
                                             buffer<char>& buf) {
